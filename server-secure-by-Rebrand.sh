...
echo 
echo "#"
echo "# Server Secure script 1.0 alpha by Rebrand - August 2014"
echo "#"
echo "# - Contact : rebrand@abv.bg / rebrand@offensive-security.com"
echo "#"
echo "# - Author : Denislav Kostov"
echo "#"
echo "# - This Product Provided By : www.offensive-security.com"
echo "#"
echo
...
echo "NOTE: Run this script with  gksudo /path/to/script/server-secure-by-Rebrand.sh.x"
# Local Variables
TFCName="Ubuntu Server Secure"
TFCVersion="v0.1 by Rebrand"
UserName=$(whoami)
LogDay=$(date '+%Y-%m-%d')
